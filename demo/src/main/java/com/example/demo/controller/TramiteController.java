...
public class TramiteController {
    ...
    public ResponseEntity<?> crearTramite(@RequestBody TramiteDto tramiteDto){
        ...
        Tramite tramite = new Tramite(tramiteDto.getRadicado(), tramiteDto.getAno(), tramiteDto.getNombre(), tramiteDto.getDescripcion(), tramiteDto.getSolicitante(), tramiteDto.getFuncionario());
